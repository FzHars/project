...
class M_cuti extends CI_Model
{
    ...
    public function insert_data_cuti($id_cuti, $id_user, $alasan, $hari_cuti, $berakhir, $id_status_cuti, $perihal_cuti)
    {
        $this->db->trans_start();
        $this->db->query("INSERT INTO cuti(id_cuti,id_user, alasan, tgl_diajukan, hari_cuti, berakhir, id_status_cuti, perihal_cuti) VALUES ('$id_cuti','$id_user','$alasan',NOW(), '$hari_cuti', '$berakhir', '$id_status_cuti', '$perihal_cuti')");
    ...
    public function update_cuti($alasan, $perihal_cuti, $tgl_diajukan, $hari_cuti, $berakhir, $id_cuti)
    {
        $this->db->trans_start();
        $this->db->query("UPDATE cuti SET alasan='$alasan', perihal_cuti='$perihal_cuti', tgl_diajukan='$tgl_diajukan', hari_cuti='$hari_cuti', berakhir='$berakhir' WHERE id_cuti='$id_cuti'");
        $this->db->trans_complete();
        if ($this->db->trans_status() == true)
            return true;
        else
