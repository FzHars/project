...
class M_user extends CI_Model
{
    ...
    {
        $hasil = $this->db->query("SELECT * FROM user JOIN user_level ON user.id_user_level = user_level.id_user_level WHERE user.id_user = '$id_user'");
        return $hasil;
    }
    ...
    public function update_user_admin($id, $username, $email,$password)
    {
        $this->db->trans_start();

        $this->db->query("UPDATE user SET username='$username', email='$email', password='$password' WHERE id_user='$id'");
