                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="<?= base_url(); ?>Cuti/edit_cuti_admin"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="hari_cuti">Pilih Hari Cuti</label>
                                                                        <select id="hari_cuti" name="hari_cuti" class="form-control" aria-describedby="hari_cuti" required>
                                                                            <option disabled selected value>Pilih Berapa Hari</option>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="date" class="form-control"
                                                                            ...
                                                                            name="berakhir" value="<?= $berakhir ?>" required readonly>
                                                                    </div>
                                                                    <button type="submit"
